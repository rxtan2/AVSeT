...
class MUSICMixDataset(BaseDataset):
    def __init__(self, list_sample, opt, **kwargs):
        ...
        self.bbox_anns = pickle.load(open("/research/rxtan/object-detection/models/Sound-of-Pixels/gradcam_box_annotations/albef_monophonic_boxes.pkl", 'rb'))
        self.clips = list(self.bbox_anns.keys())
        
        self.neg_cats = pickle.load(open("/research/rxtan/object-detection/models/Sound-of-Pixels/gradcam_box_annotations/albef_monophonic_negs_list.pkl", 'rb'))
