...
OPTS+="--ckpt ./ckpt/test_base_lr_%s_audio_lr_%s_visual_lr_%s "
OPTS+="--log_path ./logs/test_base_lr_%s_audio_lr_%s_visual_lr_%s.txt "
OPTS+="--tensorboard_path ./tensorboard_plots/test_base_lr_%s_audio_lr_%s_visual_lr_%s "

# Models
OPTS+="--arch_sound audiovisual7layerunet "
OPTS+="--arch_synthesizer linear "
OPTS+="--arch_frame clip-res50-joint-textproj-normalize-scale-maxpool-framewise-finetune-traintext "
...
python -u -W ignore bottleneck_clip_joint_main.py $OPTS
