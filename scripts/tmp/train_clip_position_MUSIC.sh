...
OPTS+="--arch_frame clip-res50-joint-textproj-normalize-scale-finetune-traintext-maxpool "
...
OPTS+="--text_embeddings_path ./precomputed_features/clip_text_position_instrument_name_features.npy "
