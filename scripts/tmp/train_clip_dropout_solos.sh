...
#OPTS+="--arch_frame clip-res50-joint-textproj-normalize-scale-finetune-traintext-maxpool-framewise-dropout "
OPTS+="--arch_frame clip-res50-dropout-joint-textproj-normalize-scale-maxpool-framewise-finetune "
...
python -u -W ignore clip_joint_dropout_main.py $OPTS
