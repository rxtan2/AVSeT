...
OPTS+="--ckpt ./ckpt/video_res50_moco_sound_pixels_%s "
OPTS+="--log_path ./logs/video_res50_moco_model_bs_%s.txt "
OPTS+="--tensorboard_path ./tensorboard_plots/video_res50_moco_model_bs_%s "

# Models
OPTS+="--arch_sound unet7 "
OPTS+="--arch_synthesizer linear "
OPTS+="--arch_frame resnet50dilated-moco "
