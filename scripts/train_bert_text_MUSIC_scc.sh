...
#OPTS+="--ckpt ./ckpt/solos_dataset_experiments/text_ablations/run_1_ratio_roberta_base_text_sound_pixels_bs_%s_audio_lr_%s_syn_lr_%s_frozen "
#OPTS+="--log_path ./logs/solos_dataset_experiments/text_ablations/run_1_ratio_roberta_base_text_model_bs_%s_audio_lr_%s_syn_lr_%s_frozen.txt "
#OPTS+="--tensorboard_path ./tensorboard_plots/solos_dataset_experiments/text_ablations/run_1_ratio_roberta_base_text_model_bs_%s_audio_lr_%s_syn_lr_%s_frozen "
