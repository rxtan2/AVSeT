...
OPTS+="--ckpt ./ckpt/test_%s_audio_lr_%s_visual_lr_%s_regloss_lr_%s "
OPTS+="--log_path ./logs/test_%s_audio_lr_%s_visual_lr_%s_regloss_lr_%s.txt "
OPTS+="--tensorboard_path ./tensorboard_plots/test_%s_audio_lr_%s_visual_lr_%s_regloss_lr_%s "
...
OPTS+="--arch_frame clip-res50-distill-attn-combinedvis-normalize-scale-kldiv "
...
OPTS+="--latent_concept_path ./precomputed_features/latent_features/solos_1_latent_concept_sgd_epoch_10000_lr_10.0_model.npy "
...
python -u -W ignore bottleneck_clip_combinedvis_distill_main.py $OPTS
